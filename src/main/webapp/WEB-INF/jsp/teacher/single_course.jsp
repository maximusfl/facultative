                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="100" class="form-control" name="raiting"
                                           id="exampleFormControlTextarea1" rows="1" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">resume</label>
                                    <textarea class="form-control" maxlength="900" name="resume"
